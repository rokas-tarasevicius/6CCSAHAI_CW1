...
def main():
    ...
    audio_dir = BACKEND_ROOT / "video_service" / "assets" / "debug_audio"
    video_dir = BACKEND_ROOT / "video_service" / "assets" / "debug_video"
    temp_dir = BACKEND_ROOT / "video_service" / "assets" / "debug_temp"
