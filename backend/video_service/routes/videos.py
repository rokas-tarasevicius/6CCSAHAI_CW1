...
async def get_diagnostics():
    ...
    diagnostics = {
        ...
        "directories": {
            "videos_dir": str(BACKEND_ROOT / "video_service" / "assets" / "video"),
            "audio_dir": str(BACKEND_ROOT / "video_service" / "assets" / "audio"),
            "images_dir": str(BACKEND_ROOT / "video_service" / "assets" / "images"),
            "videos_dir_exists": (BACKEND_ROOT / "video_service" / "assets" / "video").exists(),
            "audio_dir_exists": (BACKEND_ROOT / "video_service" / "assets" / "audio").exists(),
            "images_dir_exists": (BACKEND_ROOT / "video_service" / "assets" / "images").exists()
        }
    }
    
    # Count existing files
    video_dir = BACKEND_ROOT / "video_service" / "assets" / "video"
    audio_dir = BACKEND_ROOT / "video_service" / "assets" / "audio"
    if video_dir.exists():
